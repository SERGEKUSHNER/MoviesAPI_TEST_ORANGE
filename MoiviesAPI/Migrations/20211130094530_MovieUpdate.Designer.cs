...
namespace MoiviesAPI.Migrations
{
    ...
    [Migration("20211130094530_MovieUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.MoviesActors", b =>
                {
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.MoviesGenres", b =>
                {
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.MoviesActors", b =>
                {
                    b.HasOne("MoiviesAPI.Entities.Movie", "Movie")
                        .WithMany("MoviesActors")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoiviesAPI.Entities.Person", "Person")
                        .WithMany("MoviesActors")
            ...
            modelBuilder.Entity("MoiviesAPI.Entities.MoviesGenres", b =>
                {
                    b.HasOne("MoiviesAPI.Entities.Genre", "Genre")
